...
|------|----------|---------|
| `nixos` | NixOS | nixos-rebuild |
| `linux-server` | Linux server (non-NixOS) | home-manager |
| `wsl` | WSL2 | home-manager |
| `work` | Linux work machine (non-NixOS) | home-manager |
...
**NixOS** — rebuild the system configuration:
